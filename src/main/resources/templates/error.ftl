...
<!-- top menu -->
<div class="top-menu">
	<a href="http://os7blue.com" class="with-tooltip" title="Return to the home page">Home</a> | <a href="http://os7blue.com" class="with-tooltip" title="Navigate through our sitemap">Sitemap</a> | <a href="http://os7blue.com" class="with-tooltip" title="Contact us!">Contact</a>
</div>
<!-- top menu -->
